...
with st.sidebar:
    ...
    last_name = st.text_input("Last Name", "Morgan")
    email = st.text_input("Email", "alex.morgan@salesforce.com")
    company = st.text_input("Company", "Salesforce")
    ...
    if 'analysis' in st.session_state:
        ...
        with c2:
            ...
            if r['grade'] == "HOT" and r['email_content']:
                ...
                col_a.download_button("📥 Download", r['email_content'],
                    file_name=f"email_{r['lead_data']['first_name']}_{r['lead_data']['last_name']}.txt")
                if col_b.button("📧 Send via Gmail"):
                    success, msg = send_email(
                        r['lead_data']['email'],
                        f"Quick note for {r['lead_data']['first_name']}",
                        r['email_content']
                    )
                    if success:
                ...
                st.info(f"Score is {r['score']}/100 — AI email triggers at 70+")
